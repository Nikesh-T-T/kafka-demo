...
public class ProducerDemoWithCallback {
    ...
    public static void main(String[] args) {
        ...
        log.info("From ProducerDemoWithCallback");
        ...
        prodecerProperties.setProperty("batch.size", "400");
//        prodecerProperties.setProperty("partitioner.class", RoundRobinPartitioner.class.getName());
